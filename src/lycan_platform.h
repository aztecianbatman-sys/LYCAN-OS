...
class Security { public: bool allow(const std::string&,const std::string&); bool check(const std::string&,const std::string&)const; private:std::unordered_map<std::string,std::vector<std::string>>a_;};
